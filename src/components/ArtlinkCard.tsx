...
const ArtlinkCard: React.FC<ArtlinkProps> = ({ ...props }: ArtlinkProps) => {
  ...
  return (
    <Card
      ...
      onClick={() => {}}
      className="artlink-card cursor-pointer"
    ></Card>
  );
};

export default ArtlinkCard;
