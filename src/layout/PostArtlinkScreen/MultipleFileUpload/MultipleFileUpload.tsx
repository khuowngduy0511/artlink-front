...
export default function MultipleFileUpload({
  ...
  const validateImage = async (file: File) => {
    ...
    try {
      ...
      // Dùng model mặc định (tự động fallback nếu AWS S3 lỗi)
      ...
      console.log(`NSFW check failed for ${file.name}, skipping validation:`, error);
      // Nếu lỗi thì coi như ảnh OK (bỏ qua NSFW check)
      setValidationResults((prevResults) => ({ ...prevResults, [file.name]: true }));
    }
