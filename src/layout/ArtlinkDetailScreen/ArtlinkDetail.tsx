...
import "./ArtlinkDetail.scss";
import {
  addFollow,
  fetchArtlinkDetail,
  fetchCommentsForArtlinkRealTime,
  fetchIsFollow,
  removeFollow,
} from "./Service";
...
import { ArtlinkDetailType, CommentType } from "./ArtlinkDetailType";
import { getAuthInfo } from "../../util/AuthUtil";
import { ProgressSpinner } from "primereact/progressspinner";
import MinnorContentRight from "./MinnorContentRight";

export default function ArtlinkDetail() {
  const id = useParams().id || "";
  const [data, setData] = useState({} as ArtlinkDetailType);
  ...
  const fetchDetail = () => {
    setIsLoading(true);
    fetchArtlinkDetail(id, currentUserId)
      .then((res) => {
        setData(res);
