...
export default function Forbidden401() {
  return (
    <>
      <Helmet>
        <title>401 Không được truy cập</title>
        <meta
          name="description"
          content="Rất tiếc, bạn không có quyền truy cập trang này. Vui lòng liên hệ với quản trị viên để được hỗ trợ."
        />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="text-600 mb-5">
                Rất tiếc, bạn không có quyền truy cập trang này. Vui lòng liên hệ với quản trị viên
                để được hỗ trợ.
              </div>
              <Link
                to="/"
